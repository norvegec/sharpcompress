...
namespace SharpCompress.Test
{
    ...
    public class ZipReaderTests : ReaderTests
    {
        ...
        [TestMethod]
        public void Zip_Multi_Reader()
        {
            var testArchives = new[] { "Zip.multi.zip.001", "Zip.multi.zip.002" };
...
//                var reader =
//                    ZipReader.Open(
//                                   testArchives.Select(s => Path.Combine(TEST_ARCHIVES_PATH, s)).Select(File.OpenRead)
//                                       .Cast<Stream>()))
//            {
//                while (reader.MoveToNextEntry())
//                {
